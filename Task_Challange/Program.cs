...
namespace Task_Challenge
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var C2 = a.NumberFormat.CurrencySymbol;
            ...
            saving.ApplyInterest();//movcud balansa faiz tetbig edilir
            // Savings balance should now be 1050.63
            Console.WriteLine($"Savings balance is {saving.Balance + C2}");

            // More than 3 Savings withdrawals should result in 2.00 charge
            saving.Withdraw(10.0m);//xerce -2.00 mebleginde komissiya tutulur
            ...
            // try to overdraw checking - should result in extra charge 35.00
